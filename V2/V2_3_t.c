...
int t3=0, time=0, counter3=0, loop_start_time=0, loop_end_time=0, loop_duration=0;
...
interrupt [TIM0_COMP] void timer0_comp_isr(void) { t1++; t2++; t3++; }
