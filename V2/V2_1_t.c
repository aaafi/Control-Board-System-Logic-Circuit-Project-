...
int keypad_touch=0, start=0, t1=0, t2=0, t3=0, counter=0, menu=1, option=1, clc=0, D1=1, D2=1, list=0, t4=0, time=0, counter3=0, loop_start_time=0, loop_end_time=0, loop_duration=0;
